// Casting is the process of converting a value between types. All C++-style casts are of the form cast type<type>(value), where type is the type you’re casting to. The possible cast types to replace cast type with are:
